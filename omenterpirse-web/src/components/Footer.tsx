...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-brand py-10 px-8 text-white/60 font-inter mt-auto">
      ...
      <div className="max-w-7xl mx-auto mt-10 pt-8 border-t border-white/5 flex flex-col items-center justify-center text-center text-[10px] uppercase tracking-[0.2em] space-y-2">
        <p className="text-white/20">© 2026 OM Enterprises. All rights reserved.</p>
        <p className="text-white/20">Quality, Reliability & Trust</p>
      </div>
    </footer>
  );
}
