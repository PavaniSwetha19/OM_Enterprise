        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden lg:flex items-center space-x-6 mr-4">
                ...
                navItems.map((item) => {
                  ...
                  return (
                    <Link
                      key={item.id}
                      href={item.href}
                      className={`text-[11px] md:text-[13px] font-bold tracking-wide transition-all duration-300 relative group py-1 whitespace-nowrap ${isActive ? "text-[#C5A059]" : "text-white hover:text-[#C5A059]"
                        }`}
                    >
                      {item.label}
              ...
              >
                <button
                  className={`text-[11px] md:text-[13px] font-bold tracking-wide transition-all duration-300 flex items-center gap-1 ${isCollectionsOpen ? "text-[#C5A059]" : "text-white hover:text-[#C5A059]"
                    }`}
                >
                  Collections
            ...
            <div className="hidden md:flex items-center space-x-4 ml-auto text-white">
              ...
              {user ? (
                ...
                <button
                  ...
                  className="flex items-center space-x-2 text-xs font-bold tracking-wider bg-[#C5A059] text-white px-5 py-2.5 rounded-full hover:bg-[#B38E46] transition-all shadow-md cursor-pointer relative z-10"
                >
